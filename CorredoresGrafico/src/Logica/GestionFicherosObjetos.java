...
import Logica.ClaseAnhadirObjectOutputStream;
import java.io.File;
...
public class GestionFicherosObjetos {
    ...
    public GestionDeCarreras leerUnRegistroFicheroObjetos() throws IOException, ClassNotFoundException {
        ...
        return (GestionDeCarreras) registro; //devuelve el registro leido
    }
