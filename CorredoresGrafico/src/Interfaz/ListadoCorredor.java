...
public class ListadoCorredor extends javax.swing.JDialog {
    ...
    private void rellenarTablaCorredoresDisponibles() {
        jTableCorredores.setModel(new TableModelCorredores(gdCarreras.corredoresDisponibles(idCarrera, gdCorredores.getCorredores())));
    }
        ...
        if (gdCarreras != null) {
            if (numMax > gdCarreras.getListaCarreras().get(idCarrera).getListaCorredores().size()) {
                ...
                if (seleccionado == -1) {
                        ...
                        if (numMax > gdCarreras.getListaCarreras().get(idCarrera).getListaCorredores().size()) {
                            ...
                            if (!agregarCorredor) {
                                JOptionPane.showMessageDialog(this, " El corredor "
                                        + corredorSeleccionado.getNombre() + " ya paraticipa en la carrera");
                            }
                        } else {
                    ...
                    if (agregado) {
                        JOptionPane.showMessageDialog(this, "Corredores agregados");
                    }
                }
            } else {
                JOptionPane.showMessageDialog(this, "No quedan plazas");
