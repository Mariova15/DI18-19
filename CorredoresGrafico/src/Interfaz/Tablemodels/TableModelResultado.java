...
public class TableModelResultado extends AbstractTableModel {
    ...
    private final String[] columnas = {"Dorsal", "Tiempo", "Nombre", "DNI", "Dirección", "Telf", "Fecha"};

    public TableModelResultado(List<CorredorCarrera> listaCorredores) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 1:                
                return listaCorredores.get(rowIndex).getTiempoCarrera();
            case 2:
