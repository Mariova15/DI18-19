...
public class GestionDeCorredores {
    ...
    public void alta(String nombre, String dni, String direccion, int telf, String fecha) throws ParseException {
        fechaNacimiento = sdf.parse(fecha);
        corredor = new Corredor(nombre, dni, direccion, telf, fechaNacimiento);
